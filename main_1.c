/*
 * File:   main.c
 * Author: Zachariahblair & Sudarshan Naicker & Ken Liu
 *
 * Created on October 13, 2023, 11:24 AM
 */
...
// GLOBAL VARIABLES
// flags denoting the state of a button
int RA2flag = 0;
int RA4flag = 0;
int RB4flag = 0;

// flag that determines whether or not delays happen
int delayFlag = 1;
int displayFlag = 0;
...
int main(void) {
    ...
    //Start User input reading and output processing
    IOcheck();
